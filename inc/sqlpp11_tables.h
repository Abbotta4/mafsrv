...
// generated by ./ddl2cpp ./mafia.ddl sqlpp11_tables mafsrv
...
namespace mafsrv
{
  namespace PublicJwt_
  {
    ...
    struct Autheduser
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "autheduser";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T autheduser;
            T& operator()() { return autheduser; }
            const T& operator()() const { return autheduser; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::text, sqlpp::tag::can_be_null>;
    };
    struct Expiration
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "expiration";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T expiration;
            T& operator()() { return expiration; }
            const T& operator()() const { return expiration; }
          };
      };
  ...
  struct PublicJwt: sqlpp::table_t<PublicJwt,
               PublicJwt_::Token,
               PublicJwt_::Autheduser,
               PublicJwt_::Expiration>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "public.jwt";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
        T publicJwt;
        T& operator()() { return publicJwt; }
        const T& operator()() const { return publicJwt; }
      };
    };
  };
